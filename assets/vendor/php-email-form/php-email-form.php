...
if ( version_compare(phpversion(), '5.5.0', '<') ) {
  die('需要PHP版本5.5.0以上，你目前版本為: ' . phpversion());
}
...
class PHP_Email_Form {
  ...
  public $error_msg = array(
    'invalid_to_email' => '發送的電子郵件為空，請確實填寫郵件地址',
    'invalid_from_name' => '送件人不可為空!',
    'invalid_from_email' => '電子郵件無效或是空白!',
    'invalid_subject' => '標題為空或是太短!',
    'short' => '為空或是太短!',
    'ajax_error' => '抱歉，這個請求應該是Ajax POST',
    'invalid_attachment_extension' => '文件後綴名不允許，請選擇:',
    'invalid_attachment_size' => '允許最大附件大小為:'
  );
